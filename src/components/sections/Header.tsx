...
function CallModal({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-full max-w-[560px] rounded-[28px] border border-white/40 bg-white/70 p-5 text-[#121212] shadow-[0_25px_80px_rgba(0,0,0,0.05)] backdrop-blur-[22px]"
        ...
        >
          ...
          <div className="mt-1 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
            ...
            <button
              type="submit"
              disabled={!agree}
              className="h-11 rounded-[999px] bg-[#c73f40] px-5 text-[14px] font-medium text-white shadow-[0_12px_36px_rgba(199,63,64,0.05)] hover:bg-[#b43738] active:bg-[#9f2f30] disabled:cursor-not-allowed disabled:opacity-60"
            >
              Отправить
            </button>
          </div>
    ...
    <>
      <header className="sticky top-4 z-50">
        <div className="mx-auto max-w-[1240px] px-4">
          <div className="rounded-[999px] border border-white/40 bg-white/15 p-2 shadow-[0_12px_36px_rgba(0,0,0,0.05)] backdrop-blur-[24px]">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="hidden md:flex items-center gap-2">
                <button
                  ...
                  className="grid h-10 w-10 place-items-center rounded-full border border-white/40 bg-white/16 text-white shadow-[0_10px_28px_rgba(0,0,0,0.05)] backdrop-blur-[18px] hover:bg-white/22"
                ...
                <a
                  href={LINKS.start}
                  className="inline-flex h-10 items-center justify-center rounded-full bg-[#c73f40] px-4 text-[13px] font-semibold text-white shadow-[0_16px_42px_rgba(199,63,64,0.05)] hover:bg-[#b43738] active:bg-[#9f2f30]"
                >
                  Начать бесплатно
                </a>
              </div>
