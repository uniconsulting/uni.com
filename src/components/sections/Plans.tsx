              ...
              {PLANS.map((p) => {
                ...
                return (
                  <div
                    key={p.key}
                    className={[
                      "relative overflow-hidden rounded-[26px] border border-white/22 bg-white/65 shadow-[0_18px_55px_rgba(0,0,0,0.03)] backdrop-blur-[20px] backdrop-saturate-150 p-[10px]",
