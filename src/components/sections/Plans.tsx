...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    title: "Энтерпрайз",
    desc:
      "Для крупных компаний: макс. персонализация, SLA и постоянное вовлечение команды ЮНИ.",
    priceMonthly: 99900,
    integrationNote: "интеграции: от 179 900₽ / разово *",
    paramsTitle: "Ключевые параметры",
    params: ["Индивидуальные лимиты"],
    cta: "Заказать звонок",
    variant: "outline",
  },
];
                ...
                return (
                  ...
                  >
                    <div className="p-5">
                      ...
                      <div className="mt-2 text-[13px] leading-[1.35] text-[#475467] min-h-[52px]">
                        {p.desc}
                      </div>
